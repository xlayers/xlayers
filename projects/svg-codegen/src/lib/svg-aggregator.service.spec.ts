...
describe('SvgAggregatorService', () => {
    ...
    it('should have three files for a basic svg component', () => {
        ...
        expect(svg.value.indexOf('<path fill="none" d="M54 34,S 53.566 36, 53.036 36,S 0.964 36, 0.964 36,S 0 35.1, 0 34,S 0 2, 0 2,S 0.434 0, 0.964 0,S 53.036 0, 53.036 0,S 54 0.9, 54 2,L 54 34,z"/>') >= 0).toEqual(true);
    });
});
