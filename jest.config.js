module.exports = {
  ...
  moduleNameMapper: {
    ...
    "^@xlayers/text-blocgen":
      "<rootDir>/projects/text-blocgen/src/public_api.ts",
    ...
    "^@xlayers/bitmap-blocgen":
      "<rootDir>/projects/bitmap-blocgen/src/public_api.ts",
    "^@xlayers/bitmap-blocgen/(.*)":
      "<rootDir>/projects/bitmap-blocgen/src/lib/$1"
  }
};
